...
from dpmp_gtfs.web.coverage import build_coverage, simplify
...
def test_a_straight_line_collapses_to_its_endpoints() -> None:
    ...
    assert simplify(line, 0.001) == [(0.0, 0.0), (3.0, 3.0)]
...
def test_a_long_wiggle_is_actually_shortened() -> None:
    ...
    assert len(simplify(line, 0.001)) < len(line) / 5
